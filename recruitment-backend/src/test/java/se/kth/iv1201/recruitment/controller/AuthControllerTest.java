...
/**
 * Tests the login endpoint with valid credentials to ensure it returns a status of 200 OK
 ...
 */
  ...
  /**
   * Verifies that the login endpoint returns a 401 Unauthorized status when given invalid credentials.
   * @throws Exception
   */
  @Test
  ...
  /**
   * Verifies that the logout endpoint properly clears the JWT cookie by setting its value to an empty string
