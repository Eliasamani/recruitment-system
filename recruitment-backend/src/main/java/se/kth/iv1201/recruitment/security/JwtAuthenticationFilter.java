...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
  ...
  /**
   * Checks if the request contains a valid JWT, and if so, sets the authentication context according to role.
   * If no JWT is present, or if the token is invalid, the request is passed to the next filter in the chain
