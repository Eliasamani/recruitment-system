...
public class SecurityConfig {
     ...
     * (/, /api/auth/session, /api/auth/login, /api/users/register, /index.html,
     * /static/**, /*.png, /*.json, /*.ico, /*.txt, /error),
     * which are accessible by anyone.
     * The /api/auth/logout endpoint requires authentication, but does not require
     * any specific role.
     * The /api/auth/protected endpoint requires the RECRUITER role.
     * All other endpoints require authentication.
     * Session management is disabled, making authentication fully stateless (JWT
    ...
    /**
     * Provides a PasswordEncoder bean that uses BCrypt hashing algorithm for
     * encrypting passwords.
     * BCrypt is a strong hashing algorithm that automatically handles salting and
     * is designed to be computationally intensive
     ...
     * This configuration allows the application to accept requests from specific
     * origins,
     * enabling the frontend and backend to communicate securely across different
     * domains.
     * 
     ...
     * 
     * @return An instance of UrlBasedCorsConfigurationSource with the defined CORS
     *         settings.
     */
